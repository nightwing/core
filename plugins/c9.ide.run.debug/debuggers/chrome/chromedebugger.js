define(function(require, exports, module) {
    ...
    function main(options, imports, register) {
        ...
        - reconnect
        - break at start
        - conflicting state at onchangerunning
        - 
        */
        /***** Initialization *****/
        ...
        function handleDebugBreak(breakpoints, reconnect, frame, attach, callback) {
            ...
            function wait() {
                ...
                function resumeIfNeeded(callback) {
                    var onBreakpoint = activeFrame && breakpoints.some(function(bp) { 
        ...
        function createFrame(frameData, index) {
            ...
            frame.scopes = options.scopeChain.map(function(scope) {
        ...
        function getProxySource(process) {
            return false
            var port = (process.runner[0] || process.runner).debugport;
            var socketPath = c9.homeDir + "/.c9/nodeDebugProxy.socket";
            ...
            return {
                ...
                // detach: true,
                args: [
                    "plugins/c9.ide.run.debug/debuggers/chrome/chrome-debug-proxy.js",
                    socketPath,
                    port
                ],
            };
        ...
        function attach(s, reconnect, callback) {
            ...
            attached = false;
            v8dbg.attach(0, function(err, msg) {
                if (err) return callback(err);
        ...
        function setVariable(variable, parents, value, frame, callback) {
            // Get variable name
            v8dbg.setvariablevalue(variable, parents, value, frame, callback);
        }
